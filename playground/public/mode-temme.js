  ...
  function (require, exports) {
    ...
    function filters(next) {
      return [
        {
          // filter with args
          token: ['text.temme-filter-bar', 'entity.name.function.temme-filter-name', 'paren.lparen'],
          regex: `(\\||\\|\\|)(${identifierReg})(\\()`,
          push: 'argsState',
        },
        {
          // filter without args
          token: ['text.temme-filter-bar', 'entity.name.function.temme-filter-name'],
          regex: `(\\||\\|\\|)(${identifierReg})`,
        },
        {
          regex: '',
        ...
        this.$rules = {
          ...
          start: [
            ...
            },
            {
              ...
              token: ['storage.type.temme-inline-filter-definition', 'text', 'entity.name.function'],
            ...
            {
              token: "paren.rparen.temme-selector-close",
              regex: "\\}",
              next: 'pop',
            },
            {
          ...
          attrState: [
            ...
            {
              token: 'constant.temme-attr-name',
              regex: identifierReg,
            },
            {
          ...
          contentState: [
            ...
            { include: 'jsLiteralState' },
            {
              ...
              token: "variable.parameter.temme-content-capture",
              regex: `\\$(?:${identifierReg})?`,
              push: filters(),
            },
            {
              // content function call
              token: ["entity.name.function.temme-content-function-name", "text", "paren.lparen"],
              regex: "(" + identifierReg + ")(\\s*)(\\()",
              push: "argsState"
            },
            {
          ...
          argsState: [
            ...
            {
              token: 'paren.rparen.temme-args-end',
              regex: '\\)',
              next: 'pop',
            },
          ],
